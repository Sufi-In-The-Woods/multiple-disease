...
if selected == 'Diabetes Prediction':
    ...
    with col1:
        DiabetesPedigreeFunction = st.number_input('Diabetes Pedigree Function value', min_value=0.0, max_value=3.0, value=0.0)
    
    with col2:
        Age = st.number_input('Age of the Person', min_value=0, max_value=120, value=0)
    
    if st.button('Diabetes Test Result'):
        diab_diagnosis = predict_diabetes(Pregnancies, Glucose, BloodPressure, SkinThickness, Insulin, BMI, DiabetesPedigreeFunction, Age)
